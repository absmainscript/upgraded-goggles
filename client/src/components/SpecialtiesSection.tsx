    ...
    >
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          ...
          >
            <span className={`text-xs font-medium text-white px-6 py-2 rounded-full ${badgeGradientCSS ? `bg-gradient-to-r ${badgeGradientCSS}` : 'text-purple-600 bg-purple-50 border border-purple-100'} shadow-lg backdrop-blur-sm`}>
              ESPECIALIDADES
            </span>
          </motion.div>
          ...
          {/* Título redesenhado */}
          <motion.h2 
            className="font-light text-4xl md:text-5xl lg:text-6xl text-slate-800 mb-8 tracking-tight leading-tight"
          ...
          <motion.p 
            className="text-slate-600 text-lg md:text-xl max-w-2xl mx-auto leading-relaxed font-light"
            initial={{ opacity: 0 }}
