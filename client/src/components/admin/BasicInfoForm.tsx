...
export function BasicInfoForm({ configs }: BasicInfoFormProps) {
  ...
  const basicSchema = z.object({
    ...
    headerName: z.string().min(1, "Nome no header é obrigatório"),
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>Nome na Seção "Sobre Mim"</FormLabel>
                    <FormControl>
                      <Input placeholder="Dra. (Adrielle Benhossi)" {...field} />
                    </FormControl>
                    <p className="text-xs text-muted-foreground">
                      Use parênteses para aplicar gradiente: Dra. (Adrielle Benhossi)
                    </p>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>Nome no Header/Navegação</FormLabel>
                    <FormControl>
                      <Input placeholder="Dra. Adrielle Benhossi" {...field} />
                    </FormControl>
                    <p className="text-xs text-muted-foreground">
                      Nome simples que aparece no menu de navegação
                    </p>
                    <FormMessage />
                  </FormItem>
                )}
