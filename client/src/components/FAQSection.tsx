        ...
        <div className="container mx-auto max-w-4xl px-6 text-center">
          ...
          >
            <div className="inline-block mb-6">
              <span className={`text-xs font-medium text-white px-4 py-1.5 rounded-full bg-gradient-to-r ${badgeGradient ? BADGE_GRADIENTS[badgeGradient as keyof typeof BADGE_GRADIENTS] || 'from-pink-500 to-purple-600' : 'from-pink-500 to-purple-600'} tracking-wider uppercase`}>
